...
type Transaction struct {
	...
	FromBankID         null.String       `boil:"from_bank_id" json:"from_bank_id,omitempty" toml:"from_bank_id" yaml:"from_bank_id,omitempty"`
	ToBankID           null.String       `boil:"to_bank_id" json:"to_bank_id,omitempty" toml:"to_bank_id" yaml:"to_bank_id,omitempty"`
	ExpensesCategoryID null.String       `boil:"expenses_category_id" json:"expenses_category_id,omitempty" toml:"expenses_category_id" yaml:"expenses_category_id,omitempty"`
	TransferFee        types.NullDecimal `boil:"transfer_fee" json:"transfer_fee,omitempty" toml:"transfer_fee" yaml:"transfer_fee,omitempty"`
...
var TransactionColumns = struct {
	...
	ToBankID:           "to_bank_id",
	ExpensesCategoryID: "expenses_category_id",
...
var TransactionTableColumns = struct {
	...
	ExpensesCategoryID: "transactions.expenses_category_id",
	TransferFee:        "transactions.transfer_fee",
...
var TransactionWhere = struct {
	...
	FromBankID         whereHelpernull_String
	ToBankID           whereHelpernull_String
	ExpensesCategoryID whereHelpernull_String
	TransferFee        whereHelpertypes_NullDecimal
	...
	FromBankID:         whereHelpernull_String{field: "\"transactions\".\"from_bank_id\""},
	ToBankID:           whereHelpernull_String{field: "\"transactions\".\"to_bank_id\""},
	ExpensesCategoryID: whereHelpernull_String{field: "\"transactions\".\"expenses_category_id\""},
	TransferFee:        whereHelpertypes_NullDecimal{field: "\"transactions\".\"transfer_fee\""},
	Amount:             whereHelpertypes_Decimal{field: "\"transactions\".\"amount\""},
	Descriptions:       whereHelpernull_String{field: "\"transactions\".\"descriptions\""},
}
...
type transactionR struct {
	FromBank *UserBank `boil:"FromBank" json:"FromBank" toml:"FromBank" yaml:"FromBank"`
	ToBank   *UserBank `boil:"ToBank" json:"ToBank" toml:"ToBank" yaml:"ToBank"`
...
func (r *transactionR) GetFromBank() *UserBank {
	if r == nil {
		return nil
	}
	return r.FromBank
...
func (r *transactionR) GetToBank() *UserBank {
	if r == nil {
		return nil
	}
	return r.ToBank
...
var (
	transactionAllColumns            = []string{"id", "user_id", "from_bank_id", "to_bank_id", "expenses_category_id", "transfer_fee", "amount", "descriptions"}
	transactionColumnsWithoutDefault = []string{"user_id", "amount"}
	transactionColumnsWithDefault    = []string{"id", "from_bank_id", "to_bank_id", "expenses_category_id", "transfer_fee", "descriptions"}
...
func (o *Transaction) FromBank(mods ...qm.QueryMod) userBankQuery {
...
func (o *Transaction) ToBank(mods ...qm.QueryMod) userBankQuery {
	queryMods := []qm.QueryMod{
...
func (transactionL) LoadFromBank(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		if !queries.IsNil(object.FromBankID) {
		...
		for _, obj := range slice {
			...
			if !queries.IsNil(obj.FromBankID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.FromBankID, foreign.ID) {
...
func (transactionL) LoadToBank(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTransaction interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		if !queries.IsNil(object.ToBankID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ToBankID, foreign.ID) {
...
func (o *Transaction) SetFromBank(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserBank) error {
	var err error
	if insert {
	...
	queries.Assign(&o.FromBankID, related.ID)
	if o.R == nil {
		o.R = &transactionR{
			FromBank: related,
		}
...
// RemoveFromBank relationship.
// Sets o.R.FromBank to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Transaction) RemoveFromBank(ctx context.Context, exec boil.ContextExecutor, related *UserBank) error {
	var err error

	queries.SetScanner(&o.FromBankID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("from_bank_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.FromBankTransactions {
		if queries.Equal(o.FromBankID, ri.FromBankID) {
			continue
		}

		ln := len(related.R.FromBankTransactions)
		if ln > 1 && i < ln-1 {
			related.R.FromBankTransactions[i] = related.R.FromBankTransactions[ln-1]
		}
		related.R.FromBankTransactions = related.R.FromBankTransactions[:ln-1]
		break
	}
	return nil
}
...
func (o *Transaction) SetToBank(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserBank) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	queries.Assign(&o.ToBankID, related.ID)
	if o.R == nil {
		o.R = &transactionR{
			ToBank: related,
		}
...
// RemoveToBank relationship.
// Sets o.R.ToBank to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Transaction) RemoveToBank(ctx context.Context, exec boil.ContextExecutor, related *UserBank) error {
	var err error

	queries.SetScanner(&o.ToBankID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("to_bank_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.ToBankTransactions {
		if queries.Equal(o.ToBankID, ri.ToBankID) {
			continue
		}

		ln := len(related.R.ToBankTransactions)
		if ln > 1 && i < ln-1 {
			related.R.ToBankTransactions[i] = related.R.ToBankTransactions[ln-1]
		}
		related.R.ToBankTransactions = related.R.ToBankTransactions[:ln-1]
		break
	}
	return nil
}
