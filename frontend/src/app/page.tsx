  ...
  return (
    <div className="flex h-screen bg-neutral-100">
      ...
      <div className="flex-1 p-6 overflow-auto">
        {/* Header */}
        <div className="bg-yellow-400 rounded-3xl p-8 mb-4">
          ...
          <div className="flex justify-between items-end">
            <div>
              <p className="text-gray-700 mb-1">Total holding</p>
              <h2 className="text-4xl font-bold">$547,197.72</h2>
            </div>
            <div>
              <p className="text-gray-700 mb-1">Borrowed funds</p>
        ...
        <div className="mb-4">
          <button
            className="w-full bg-orange-200 hover:bg-orange-300 p-4 rounded-2xl flex justify-between items-center"
        ...
        <div className="mb-4">
          <button
            className="w-full bg-blue-200 hover:bg-blue-300 p-4 rounded-2xl flex justify-between items-center"
